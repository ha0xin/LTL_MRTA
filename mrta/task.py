class Task(object):
    def __init__(self, case=None, n_robot=None):
        ...
        # ------------------ case 2 -----------------
            ...
            self.formula = (
                "[]<> (l2_1_2_1 && <> (l3_1_2_1)) && [] (l5_1_1_2 -> X (l5_1_1_2 U l4_2_1_0)) && []! l4_1_2"  # task 4
            )
        elif case == 5:
            self.formula = "<> (l4_2_1_1 && X (l4_2_1_1 U l3_1_2_0)) && [] <> (l4_2_1_1 && <> l3_2_1_1)"  # task 5
        elif case == 6:
            self.formula = (
                "[]<> (l3_1_1_1 || l5_1_1_1) && []<> (l3_2_2_0 || l5_2_2_0) && []<> l2_1_1_1"
                "&& []! l4_1_2 && []! l4_2_2"
            )  # task 6
        elif case == 7:
            self.formula = (
                "[]<> (l4_2_1_0 && X (<> !l4_2_1)) && []<> (l5_1_1_0 && X (<> !l5_1_1)) "
                "&& <> (l3_1_3_0 && l3_2_2_0) "
            )  # task 7
        elif case == 8:
            self.formula = (
                "[]<> (l4_2_2_1 && <> (l2_2_2_1 && <> l5_2_2_1)) "
        ...
        # ----------------- case 3 ------------------
            ...
            self.formula = (
                "[]<> l2_1_{0}_0 && []<> l3_1_{1}_0 && [] <> l4_1_{2}_0 && (!l4_1_1 U (l5_1_1_0 && l6_1_1_0))".format(
                    n_robot, n_robot // 2, n_robot // 2
                )
            )
        elif case == 10:
            self.formula = (
                "[]<> l3_1_{0}_0 && []<> (l2_1_{1}_1 && <> l4_1_{2}_1) &&  <> (l5_1_3_0 || l6_1_3_0) &&"
